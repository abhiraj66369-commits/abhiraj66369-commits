...
|---|---|---|---|---|
| [🌾 AgroMind AI](https://github.com/abhiraj66369-commits/agromind-ai) | Agriculture-only chatbot for farmers, in Hindi and English. Gemini-backed Express API with rate limiting, Helmet and CORS, plus a React chat UI with history and dark/light mode. | React • Tailwind CSS • Node.js • Express • Gemini API | 🚧 In progress | [Live ↗](https://agromind-ai-beta.vercel.app) |
